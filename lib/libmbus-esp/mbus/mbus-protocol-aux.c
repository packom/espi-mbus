...
int
ICACHE_FLASH_ATTR
mbus_variable_value_decode(mbus_data_record *record, double *value_out_real, char **value_out_str, int *value_out_str_size)
{
    int result = 0;
...
mbus_context_serial(const char *device)
{
    ...
    //os_printf("malloc mbus_serial_data\n");
...
int
ICACHE_FLASH_ATTR
mbus_read_slave(mbus_handle * handle, mbus_address *address, mbus_frame * reply)
{
